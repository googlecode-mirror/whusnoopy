...
<div class="pb">
  以下为全文图片, 里面涉及的链接为
  <ul>
  <li> <a href="<?php echo $ftpdir?>/Software/SecureCFX_6.5.3.7z">SecureCRT 6.5.3 绿色版</a>
  <li> <a href="<?php echo $ftpdir?>/Software/7z918_9.20.0.0.exe">7zip x86 9.20</a>
  <li> <a href="<?php echo $ftpdir?>/TempSpace/monaco_win.ttf">Monaco 字体</a>
  <ul>
</div>
